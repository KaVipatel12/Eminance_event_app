...
- **Responsive Design**: The app is fully responsive and works smoothly across various devices.
...
- **Database**: MongoDB
- **Authentication**: JWT, Email OTP for password reset
- **PDF Generation**: Libraries for generating PDFs (e.g., `pdfkit` or similar)
- **Admin Panel**: Admin dashboard using React.js
